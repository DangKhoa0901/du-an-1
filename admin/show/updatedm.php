    ...
    <div class="box-right__main-table">
        <div class="box-right__main-table-form">
            ...
            <form action="index.php?act=danhmuc_update" method="post" enctype="multipart/form-data">
                ...
                <input class="box-right__main-table-form-input" type="text" name="tendm" id="" value="<?= $dmone[0]['tendm'] ?>"> <br><br>
                <span>Hình ảnh</span>
                <input type="file" id="file" name="img" />
                <label for="file" class="btn-2">upload</label> <br> <br>
                <img src="<?= $dmone[0]['img'] ?>" width="100px" alt="">
                <input type="hidden" name="id" value="<?= $dmone[0]['id'] ?>">
                <input class="box-right__main-table-form-submit" type="submit" name="capnhat" value="Cập nhật">
            </form>
        </div>
        ...
        <div class="box-right__main-table-header tabel__header-library table__body">
            ...
            <div class="box-right__main-table-header-item item__icon">
                ...
                <a href="index.php?act=updateformdm&id=' . $dm['id'] . '">
